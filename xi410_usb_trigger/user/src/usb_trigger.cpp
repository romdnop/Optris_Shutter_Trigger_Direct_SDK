...
int main(int argc, char* argv[])
{
	...
	char defaultConfig[] = "generic.xml";
	char* configPath = defaultConfig;
	...
	std::cout << "Config path provided: " << configPath << std::endl;

	int ret = ::evo_irimager_usb_init(configPath, 0, 0);
	if (ret != 0)
	{
